...
class Wide_ResNetL1Pruned(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes):
        ...
        print('| Wide-Resnet-L1-pruned %dx%d' %(depth, k))
        nStages = [16, 16*k, 32*k, 64*k]

        self.conv1 = conv3x3(3,nStages[0])
        self.layer1 = self._wide_layer(wide_basic_l1_pruned, nStages[1], n, dropout_rate, stride=1)
        self.layer2 = self._wide_layer(wide_basic_l1_pruned, nStages[2], n, dropout_rate, stride=2)
        self.layer3 = self._wide_layer(wide_basic_l1_pruned, nStages[3], n, dropout_rate, stride=2)
